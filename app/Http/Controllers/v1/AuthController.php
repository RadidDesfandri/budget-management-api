...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            Mail::to($user->email)->send(
                new UserRegisteredMail($user, $frontendUrl),
            );
    ...
    public function sendResetPasswordEmail(Request $request)
    {
        ...
        Mail::to($user->email)->send(
            new ForgotPasswordMail($user, $frontendUrl),
        );
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (RateLimiter::tooManyAttempts($resetLimitKey, 1)) {
            return $this->errorResponse(
                "You can only reset your password once per week.",
                null,
                429,
            );
        }
        ...
        if (
            ...
            $user->password_changed_at->addWeek() > now()
        ) {
            return $this->errorResponse(
                "You can only reset your password once per week.",
                null,
    ...
    public function changePassword(Request $request)
    {
        ...
        if (RateLimiter::tooManyAttempts($changeLimiterKey, 1)) {
            return $this->errorResponse(
                "You can only change your password once per week.",
                null,
                429,
            );
        }
